...
serve(async (req) => {
  ...
  try {
    ...
    if (customers.data.length === 0) {
      ...
      // Mettre à jour ou créer l'entrée dans user_subscriptions
    ...
    logStep("Client Stripe trouvé", { customerId });
    ...
    if (hasActiveSub) {
      ...
      logStep("Pas d'abonnement actif");
    ...
    logStep("ERREUR dans check-subscription", { message: errorMessage });
